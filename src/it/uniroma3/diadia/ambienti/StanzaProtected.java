...
public class StanzaProtected {
	...
	public void impostaStanzaAdiacente(String direzione, Stanza stanza) {
		...
		/*
		 * for(int i=0; i<this.direzioni.length; i++) if
		 * (direzione.equals(this.direzioni[i])) { this.stanzeAdiacenti[i] = stanza;
		 * aggiornato = true; } if (!aggiornato) if (this.numeroStanzeAdiacenti <
		 * NUMERO_MASSIMO_DIREZIONI) { this.direzioni[numeroStanzeAdiacenti] =
		 * direzione; this.stanzeAdiacenti[numeroStanzeAdiacenti] = stanza;
	...
	public Stanza getStanzaAdiacente(String direzione) {
		Stanza stanza = null;
		/*
		 * for(int i=0; i<this.numeroStanzeAdiacenti; i++) if
		 * (this.direzioni[i].equals(direzione)) stanza = this.stanzeAdiacenti[i];
		 * return stanza;
		 */
	...
	public boolean removeAttrezzo(Attrezzo attrezzo) {
		 ...
		 * if(this.attrezzi[i].getNome().equals(attrezzo.getNome())) { for(int j=i;
		 * j<this.numeroAttrezzi-1;j++) { this.attrezzi[j]=this.attrezzi[j+1]; }
		 * this.attrezzi[numeroAttrezzi-1]=null; this.numeroAttrezzi--; return true;}
		 */
